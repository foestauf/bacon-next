...
* add missing files for commitzen ([018ba8b](https://github.com/foestauf/bacon-next/commit/018ba8bde81b0f6cc60230fe4668b149ac3b2e6a))
* add npx before percy command line ([4824e98](https://github.com/foestauf/bacon-next/commit/4824e98a4d621684494fe2c7e8c3351551e52845))
* add sitemap file in gitignore, it shouldn't commit to git ([344b731](https://github.com/foestauf/bacon-next/commit/344b7312df2f7e12e642a6346ef05ad9a7ca766c))
* add steps in update-deps.yml file, syntax error ([b5de445](https://github.com/foestauf/bacon-next/commit/b5de445f1f927a5a7c2b0c85746b8fd07629cb55))
* added types ([b35ddc9](https://github.com/foestauf/bacon-next/commit/b35ddc91ecad81986432dce1ba84c302e6394a5b))
* change matching regex for Cypress files ([861d545](https://github.com/foestauf/bacon-next/commit/861d54596b61b7706cfbb681df334d73b34a378e))
* code styling in blog component pages ([f4a55c4](https://github.com/foestauf/bacon-next/commit/f4a55c4234fc03ed719859c12f13bffabd120c6d))
* error generated by eslint-plugin-cypress ([7562c6b](https://github.com/foestauf/bacon-next/commit/7562c6bddb31e6941aee7e4e2bbcdabf5be3bddf))
* Eslint comment update ([8baa5d1](https://github.com/foestauf/bacon-next/commit/8baa5d160734a3cadb419534509cc6edaac57456))
* just rebuild sitemap ([831bae9](https://github.com/foestauf/bacon-next/commit/831bae93831eb5c4f259c4a0fa9ec3012ede8927))
* move getStaticPaths at the top of blog page ([83892ea](https://github.com/foestauf/bacon-next/commit/83892ea865459f59da824c9358fbf4ccea6475e6))
* remove generated files by next-sitemap ([c5d93bf](https://github.com/foestauf/bacon-next/commit/c5d93bf9fe67a6737b536edf4d50d56cd4c8af2c))
* rename from mjs to js next-sitemap file ([7d450ff](https://github.com/foestauf/bacon-next/commit/7d450ffce77f0be4c533cb1aab757f7fb1f13596))
* resolve merge conflict ([276f57a](https://github.com/foestauf/bacon-next/commit/276f57aeb0d4a346f8e19ad81ce4703458d9f41c))
* retrive PERCY_TOKEN and set token for percy cli ([afe00f2](https://github.com/foestauf/bacon-next/commit/afe00f2e47b5dbc5fb701dd2e46756f4b7e498fd))
* typo in Readme ([8f7c1b7](https://github.com/foestauf/bacon-next/commit/8f7c1b79a46406b04b90ed8a5fe5029b3c24ff8c))
* update package-lock.json ([fba016d](https://github.com/foestauf/bacon-next/commit/fba016dec202d5748e30804b1bf50e30c00ef120))
* update README file for next-sitemap ([9496217](https://github.com/foestauf/bacon-next/commit/94962171a35a07e84319374500f28a76f264a266))
* use npx npm-check-updates ([e530193](https://github.com/foestauf/bacon-next/commit/e5301939a5ff98c598899ff49bee1ad351759292))
* wait until the link rendered instead a wrong heading tag ([e38655b](https://github.com/foestauf/bacon-next/commit/e38655b853b39fdcb9bccd3a84e99dd5caa1681d))


### Features

* add auto-update GitHub Actions ([364168f](https://github.com/foestauf/bacon-next/commit/364168f3407c7cdd21da7cd1de6d9d930f89d99a))
* add blog page ([89c4ec7](https://github.com/foestauf/bacon-next/commit/89c4ec79db48f4ae09af3e8ddb3ce5a980ed8ee6))
* add commit script in package.json ([8f4719e](https://github.com/foestauf/bacon-next/commit/8f4719ec550ab0dbffa93ca1d278aa9e370a773a))
* add commitlint with config-conventional ([97a9ac7](https://github.com/foestauf/bacon-next/commit/97a9ac7dbbca3f8d4fad22a9e4a481c029cd2cb5))
* add coverage for vscode-jest and configure jest autoRun ([ad8a030](https://github.com/foestauf/bacon-next/commit/ad8a03019010577bfb8e8ed850e8d45ca274dbe9))
* add cypress and cypress eslint plugin ([5657ee6](https://github.com/foestauf/bacon-next/commit/5657ee6dab03b11020bb2ce80083669785edd6ce))
* add sitemap.xml and robots.txt from build ([545d133](https://github.com/foestauf/bacon-next/commit/545d133decee4f7d42c228049ef3bde2b9a94b0a))
* add storybook into project ([51f3748](https://github.com/foestauf/bacon-next/commit/51f3748c0cb6d9cd04cdb0d3b9d95a0f60851866))
* add tailwind css support in Storybook ([5e0d287](https://github.com/foestauf/bacon-next/commit/5e0d287cef8a898df8f1a98632a8703657282100))
* add TypeScript support for Tailwind CSS configuration ([41f1918](https://github.com/foestauf/bacon-next/commit/41f19189655abe3941485363e057812a5fcd6c02))
* add visual testing with Percy ([b0a39f5](https://github.com/foestauf/bacon-next/commit/b0a39f58e1bd0934158b0bab8ab7e4c9215e88f0))
* add vscode jest extension ([49ab935](https://github.com/foestauf/bacon-next/commit/49ab935a03f5a9d1074a155331107737fd7dad13))
* add vscode yoavbls.pretty-ts-errors extension ([3588ce1](https://github.com/foestauf/bacon-next/commit/3588ce1dd366ebaa69f97551be58528d1ae38457))
* automatically format the whole codebase with npm run format ([9299209](https://github.com/foestauf/bacon-next/commit/92992096ede4d2b3e77c3e0c96b75e5e6b84067d))
* change 'powered by' text to 'built' with ([fe0a29f](https://github.com/foestauf/bacon-next/commit/fe0a29f8fbab14c7e8c8e98a75ce488ac157e509))
* disable Husky for release ([f20c595](https://github.com/foestauf/bacon-next/commit/f20c5951e018c99421e833eef6ce14bd9632838f))
* fix heading levels increase by one ([e712e60](https://github.com/foestauf/bacon-next/commit/e712e60402f04033673d93e464d7b3c46fff7dbe))
* improve accessibility ([aa0f0b1](https://github.com/foestauf/bacon-next/commit/aa0f0b12085e31f13574fc9f4349157102d4467b))
* remove stories in the coverage from Jest ([d502869](https://github.com/foestauf/bacon-next/commit/d502869a08a0b1d9025a4ce582651c5353f29d59))
* remove warning for no extreneous deps in stories ([b243d44](https://github.com/foestauf/bacon-next/commit/b243d441e4b75566e16f5fa64d26900267eb89f5))
* rename from master to main ([10920ec](https://github.com/foestauf/bacon-next/commit/10920ece4892ca73639388116af59fdd3e077d5f))
* run github release only on completed CI workflow ([dd4de76](https://github.com/foestauf/bacon-next/commit/dd4de76b6ea013190a6ea18d69eb3764e1b915f9))
* update dependencies to the latest version ([b7609de](https://github.com/foestauf/bacon-next/commit/b7609dea1c8bd49f6ac05439740ea78894cd4a79))
* update footer message and comment ([4f74176](https://github.com/foestauf/bacon-next/commit/4f74176b05528666fd8b92a8becdc7e3c2f0db4a))
* update TypeScript to 4.9.x ([471dc70](https://github.com/foestauf/bacon-next/commit/471dc70306c69ecb524af40aa76403daa83597e2))
* use default airbnb instead of the base version ([5c05116](https://github.com/foestauf/bacon-next/commit/5c05116fb777aee09c1af7df6694e54403eaaccb))


### Reverts

* add support for all Node.js 14+, too restrictive with only Node.js 18+ ([4e27540](https://github.com/foestauf/bacon-next/commit/4e27540f638d4767fb60b612519669ad6bf69367))
* downgrade semantic-release version to 19 ([26d5a6e](https://github.com/foestauf/bacon-next/commit/26d5a6ebe2fc4fe59fef40779e132ccf1f31c09f))
* remove storybook addon-styling which is not needed ([e863fed](https://github.com/foestauf/bacon-next/commit/e863fedcbc5a1aaf808c295d80f8de95b6abd1f7))
* update dependencies and remove commitzen ([d136e02](https://github.com/foestauf/bacon-next/commit/d136e02678c5dac2e8d64c388bcfe6d48f9e2ad9))
